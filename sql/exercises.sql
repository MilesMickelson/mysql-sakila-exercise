...
SELECT city, country.country FROM city LEFT JOIN country ON city = country.country;
...
SELECT first_name, last_name, address.address, address.address2, city.city, district, address.postal_code FROM staff LEFT JOIN address ON staff.address_id = address.address_id LEFT JOIN city ON address.city_id = city.city_id;
